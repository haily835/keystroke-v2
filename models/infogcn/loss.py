...
class InfoGCN_Loss(nn.Module):
    def __init__(self, lambda_1=1e-4, lambda_2=1e-1, num_class=30):
    ...
    def forward(self, y_hat, y, z, z_prior):
        mmd_loss, l2_z_mean, z_mean = get_mmd_loss(z, z_prior, y, self.num_class)
